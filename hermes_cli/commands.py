...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("reload-mcp", "Reload MCP servers from config", "Tools & Skills",
               aliases=("reload_mcp",)),
    CommandDef("czp-ob-save", "Quick-save a link or article into Obsidian using the czp archive workflow", "Tools & Skills",
               args_hint="<url or text>"),
    CommandDef("czp-obsidian", "Run the full czp Obsidian archiving workflow", "Tools & Skills",
               args_hint="<url or text>"),
